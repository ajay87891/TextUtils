...
export default function Alert(props) {
  ...
  return (
    props.alert && <div className={`${props.alert.visi}  my-1 flex justify-center ease-in duration-500`}>
      <div id="alert-5" className="flex p-1 bg-gray-100 rounded-lg dark:bg-gray-700    " role="alert">
